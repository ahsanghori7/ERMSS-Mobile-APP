...
import { AppRegistry, StyleSheet, ScrollView, Text, View, ImageBackground, Image, 
    TouchableWithoutFeedback, Dimensions, ToastAndroid,Picker } from 'react-native'
...
class timeSheetMMS extends Component {
...
export default withNavigation(timeSheetMMS);