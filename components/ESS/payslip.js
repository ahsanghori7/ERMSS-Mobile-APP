...
import {
    ...
    TouchableWithoutFeedback, Dimensions, TextInput,BackHandler,Picker
} from 'react-native'
                        ...
                        <View style={{ flex: 1, marginTop: 50, flexDirection: 'row', justifyContent: 'center' }}>
                            ...
                            <View style={{}}>
                                <View style={styles.datePickerBox}>
                                    ...
                                    // is24Hour={false}
                                    />
                                    {/* {this.state.isDatePickerVisible ? <MonthSelectorCalendar
...
export default withNavigation(paySlip);