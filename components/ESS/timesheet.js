...
import {
    ...
    TouchableWithoutFeedback, Dimensions, TextInput, ToastAndroid,BackHandler,Picker
} from 'react-native'
...
class timeSheet extends Component {
    ...
    async submit_press() {
        let result = await b.getTimeSheetReport(this.state.user_id, this.state.curDate, '01');
        if (result == 1) {
                    ...
                    <View style={styles.container}>
                        <View style={{ flex: 1, marginTop: 0, flexDirection: 'row', justifyContent: 'center' }}>
                            ...
                            <View style={{ width: 220, height: 60 }}>
                                <View style={styles.datePickerBox} >
                                    <Image source={require('../../img/dropdown_bar.png')} style={styles.myimage} />
                                    <Picker
                                        style={{
                                            position: 'absolute',
                                            top: -5,
                        ...
                        <View style={{ flex: 1, marginTop: 50, flexDirection: 'row', justifyContent: 'center' }}>
                            ...
                            <View style={{}}>
                                <View style={styles.datePickerBox}>
                                    <Image
                                        source={require('../../img/text_fields.png')}
